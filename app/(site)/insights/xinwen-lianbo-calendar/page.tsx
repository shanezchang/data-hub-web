...
export default function CalendarPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      ...
      <p className="mb-3 font-mono text-xs uppercase tracking-[0.18em] text-accent">Insight · Seasonality</p>
        ...
        {terms.map((t) => (
          <section key={t.zh}>
            <h2 className="text-xl font-bold">
              {t.en} <span className="ml-1 font-normal text-muted">{t.zh}</span>
            </h2>
      ...
      <ul className="mt-3 space-y-1.5 text-sm text-muted">
        <li>· Counts: <code className="font-mono text-fg">GET /v1/news?q=&lt;term&gt;&amp;group_by=month</code>, then folded by calendar month across all years (2016–present).</li>
