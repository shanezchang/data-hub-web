  ...
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-4 px-5 py-8 text-sm text-muted-foreground">
        <Link href="/" className="flex items-center gap-2 font-mono font-semibold text-foreground">
          <BrandMark className="size-4" /> data·hub
        </Link>
        <span className="font-mono text-xs">
          <Link href="/changelog" className="rounded border border-border px-2 py-0.5 hover:text-foreground">平台 v{changelog.current}</Link>
